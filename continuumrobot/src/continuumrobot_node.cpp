...
int main(int argc, char **argv)
{
	...
	// 	return 0; 
	// }
	// ROS_INFO_STREAM("receive position,dw ="<<dwRel);

	// while(int Receivenum = GetReceiveNum(nDeviceType, nDeviceInd, nCANInd)<3);

	// CAN_OBJ ReceiveMotor[3];
	// dwRel = Receive(nDeviceType, nDeviceInd, nCANInd,ReceiveMotor,3,5000);
	...
	// BOOL bRel = CloseDevice(nDeviceType, nDeviceInd);//fanhuizhikanyixia 
	// ROS_INFO_STREAM("close can, bRel"<<int(bRel));
